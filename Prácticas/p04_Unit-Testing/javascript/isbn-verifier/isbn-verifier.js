 ...
 * @since Mar 11 2022
 * @desc Isbn Verifier 
 *       Given a string the program should check if the provided string is a
 *       valid ISBN-10. Putting this into place requires some thinking about
 *       preprocessing/parsing of the string prior to calculating the check
 *       digit for the ISBN. The program should be able to verify ISBN-10 both
 *       with and without separating dashes.
