...
test('Largest prime factor', () => {
  expect(() => mayorFactorPrimo())
      .toThrow('No se han introducido un número.');
});
test('Largest prime factor', () => {
  expect(() => mayorFactorPrimo([1, 2]))
      .toThrow('No se han introducido un número.');
});
...
describe('Error de formato', () => {
  ...
  test('Undefined', () => {
    expect(() => mayorFactorPrimo(undefined))
        .toThrow('No se han introducido un número.');
  });
  test('Nulls', () => {
    expect(() => mayorFactorPrimo(null))
        .toThrow('No se han introducido un número.');
  });
});
